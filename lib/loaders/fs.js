...
FileSystemLoader.metadata_file = '_metadata';
...
function FileSystemLoader(dir, options) {
    ...
    this.posts = [];
    this.ignore = utils.createSet(options.ignore || FileSystemLoader.ignore);
    this.metadata = options.metadata || {};
    var self = this;
    process.nextTick(function () {
        self.walk(self.dir, self.parse.bind(self), function (err) {
            if (err) {
